...
class EmployeeSeeder extends Seeder
{
    public function run()
    {
        ...
        $nutters_location_staff = [
            //Warehouse
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("SCOTT PHINNEY")))),'level' => 'location_staff'],
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DARCY GOERTZEN")))),'level' => 'location_staff'],
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Kevin Elderkin")))),'level' => 'location_staff'],
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Janiece Richards")))),'level' => 'location_staff'],
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("JEANETTE MACAULAY")))),'level' => 'location_staff'],
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("SANDRA LOFGREN")))),'level' => 'location_staff'],
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DEVIE MAIER")))),'level' => 'location_staff'],
            ['location_id'=>'998','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("VALERIE LEMNA")))),'level' => 'location_staff'],
            //Specialty
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("KIM MARSHALL")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DONNELLY GRAD")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ROSE WEBSTER")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("STEPHANIE ULRICHSEN")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("SANDRA NEUFELD")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DEANNA THOMPSON")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("KATHY TETLOCK-CORVINUS")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("JIM GRAD")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DEBORAH KEETLEY")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("PAT WILSON")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("TARA WASYLUK")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("LYNN FAUSER")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("MARCIA CLEMENT")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("GERDA	DE LANGE")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("SHERI LYNN BRUSKY")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("RENA MARIE BROWN")))),'level' => 'location_staff'],
            ['location_id'=>'997','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DEBRA BUECKERT")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("MICHELLE MENZIES")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ZOE 	MUDRACK")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("LORNA	FAVEL")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Darcy 	Wedrick")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("HEAVEN 	CARLTON")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("KRISTEN 	RESENER")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CELESTE 	HUNTER")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("BROOKLYN 	DAVIDSON")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Jace 	LEVEQUE")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Eileigh 	HARRIS-MCGHEE")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("JOLENE 	YANKE SHORT")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ALEXA 	RUDE")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CAITLIN 	CAMPBELL")))),'level' => 'location_staff'],
            ['location_id'=>'1','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("LIELT 	SAMKET YESHIGETA")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CLEO	TETTEH")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("RILEY	SUTHERLAND")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("SALLY	BUSBY")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CHEY-ANNE 	GILLESPIE")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CRYSTAL 	GREENWALL")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("HAROLD	JACOBSON")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ELIZABETH 	BAKER")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("TONI-LYNN 	NOBBS")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Hope	Forslund-Clark")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("NEIL ALLAN JR.	YOUNG")))),'level' => 'location_staff'],
            ['location_id'=>'3','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("TINA	JACKSON")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'45','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ELIZABETH 	SEMENIUK")))),'level' => 'location_staff'],
            ['location_id'=>'45','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("GRACE 	PEREIRA")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'44','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("BENJAMIN 	BRONSCH")))),'level' => 'location_staff'],
            ['location_id'=>'44','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CRYSTAL 	PILOTTE")))),'level' => 'location_staff'],
            ['location_id'=>'44','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("JULIE 	ANGUS")))),'level' => 'location_staff'],
            ['location_id'=>'44','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("KAYLA CRYSTAL	DESROSIERS")))),'level' => 'location_staff'],
            ['location_id'=>'44','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("MARIBEL 	SORIANO")))),'level' => 'location_staff'],
            ['location_id'=>'44','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CINDY 	KELLY")))),'level' => 'location_staff'],
            ['location_id'=>'44','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("IZABELA 	VOJSOVICOVA")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'5','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DARLA 	ENDICOTT")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'47','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("CASSANDRA 	BLYTH")))),'level' => 'location_staff'],
            ['location_id'=>'47','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ESTHER 	RATZLAFF")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'48','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DELPHINE 	MARYNIAK")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'38','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("AFTON 	MCELROY")))),'level' => 'location_staff'],
            ['location_id'=>'38','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("MARGARET 	BOWEN")))),'level' => 'location_staff'],
            ['location_id'=>'38','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("MICHAEL 	CAMPBELL")))),'level' => 'location_staff'],
            ['location_id'=>'38','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("REBECCA 	MEISL")))),'level' => 'location_staff'],
            ['location_id'=>'38','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("LINDA	FLOREN")))),'level' => 'location_staff'],
            ['location_id'=>'38','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Asia	Grant-Eshleman")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'28','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Cassidy 	STAINTON")))),'level' => 'location_staff'],
            ['location_id'=>'28','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("LYNDSEY 	HUSSEY")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'10','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("RACHEL 	BRAND")))),'level' => 'location_staff'],
            ['location_id'=>'10','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ELAINE 	GRAHAM")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'50','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DAYNA 	GAERTNER")))),'level' => 'location_staff'],
            ['location_id'=>'50','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("DANIELLE 	SABOURIN")))),'level' => 'location_staff'],
            ['location_id'=>'50','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Shelley 	Carefoot")))),'level' => 'location_staff'],
            ...
            ['location_id'=>'6','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("LORI 	BORAU")))),'level' => 'location_staff'],
            ['location_id'=>'6','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("KEN 	LOWRY")))),'level' => 'location_staff'],
            ['location_id'=>'6','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("Hannah 	Duda")))),'level' => 'location_staff'],
            ['location_id'=>'6','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("TALIA 	ASHCROFT")))),'level' => 'location_staff'],
            ['location_id'=>'6','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("ALICE 	JONES")))),'level' => 'location_staff'],
            ['location_id'=>'6','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("JUDY 	SEBERG")))),'level' => 'location_staff'],
            ['location_id'=>'6','name'           => preg_replace('!\s+!', ' ', (ucwords(strtolower("KEESHA 	HOLT")))),'level' => 'location_staff'],
