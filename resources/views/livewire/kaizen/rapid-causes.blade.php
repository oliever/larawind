        ...
        <table class="w-full table-fixed text-gray-700 dark:text-gray-400">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                        <td><textarea name="rapidCauses[{{$index}}][description]" id="rapidCauses[{{$index}}][description]"
                            ...
                            wire:model="rapidCauses.{{$index}}.description"></textarea></td>
                        <td><textarea name="rapidCauses[{{$index}}][findings]" id="rapidCauses[{{$index}}][findings]"
                            ...
                            wire:model="rapidCauses.{{$index}}.findings" ></textarea></td>
                        <td>
                            <div class="relative text-gray-500 focus-within:text-purple-600">
                            <textarea name="rapidCauses[{{$index}}][root_cause]" id="rapidCauses[{{$index}}][root_cause]"
                            ...
                            wire:model="rapidCauses.{{$index}}.root_cause"></textarea>
