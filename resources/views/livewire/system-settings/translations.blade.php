    ...
    <table class="whitespace-no-wrap">
        <thead>
            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                <th class="px-4 py-3">Field ID</th><th class="px-4 py-3">Field Label</th><th>Actions</th>
            </tr>
        </thead>
        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            ...
            @foreach ($translations as $index => $item)
                ...
                @php
                    ...
                    echo '<tr><td colspan="3" style="text-align: center"><p class="text-lg text-gray-600 dark:text-gray-400" >' . str_replace('_', ' ',ucwords($currentSection,"_")) . '</p></td></tr>';
                    }
