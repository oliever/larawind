...
<x-app-layout title="Dashboard | Kaizen">
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            <th class="px-4 py-3 w-1/5">Iniator</th>
                            <th class="px-4 py-3 w-2/5">Project</th>
                            <th class="px-4 py-3 w-1/5">Focus Area</th>
                            <th class="px-4 py-3 w-1/5">Status</th>
                            <th class="px-4 py-3 w-1/5">Date</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                Identify and track slow & non-moving inventory
                            </td>
                            <td class="px-4 py-3 text-sm">
                                Productivity
                            </td>
